...
| **默认模型** | `deepseek-v4-pro` | `glm-5.1` | `MiniMax-M2.7` | `mimo-v2.5-pro` |
| **推理能力** | `native` | `boolean` | `none` | `boolean` |
...
MiniMax 规格目标为 `https://api.minimaxi.com/v1`（[src/providers/minimax/spec.ts:24-54](https://github.com/Ahoo-Wang/GodeX/blob/main/src/providers/minimax/spec.ts#L24-54)）。
