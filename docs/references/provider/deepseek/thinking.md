...
## 思考模式开关与思考强度控制[](https://api-docs.deepseek.com/zh-cn/guides/thinking_mode#思考模式开关与思考强度控制 "思考模式开关与思考强度控制的直接链接")
...
## 输入输出参数[](https://api-docs.deepseek.com/zh-cn/guides/thinking_mode#输入输出参数 "输入输出参数的直接链接")
...
## 多轮对话拼接[](https://api-docs.deepseek.com/zh-cn/guides/thinking_mode#多轮对话拼接 "多轮对话拼接的直接链接")
...
### 样例代码[](https://api-docs.deepseek.com/zh-cn/guides/thinking_mode#样例代码 "样例代码的直接链接")
...
## 工具调用[](https://api-docs.deepseek.com/zh-cn/guides/thinking_mode#工具调用 "工具调用的直接链接")
...
### 样例代码[](https://api-docs.deepseek.com/zh-cn/guides/thinking_mode#样例代码-1 "样例代码的直接链接")
