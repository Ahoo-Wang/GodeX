...
import type { ChatCompletion, ChatCompletionChunk, ChatCompletionCreateRequest } from "../../protocol/openai/completions";
...
const OPENAI_CAPABILITIES: ProviderCapabilities = mergeCapabilities({
	supportedToolTypes: new Set([
		...
		"local_shell", "shell", "apply_patch", "tool_search", "namespace",
	]),
	reasoning: true,
...
export class OpenAIProvider implements Provider<ChatCompletionCreateRequest, ChatCompletion, ChatCompletionChunk> {
