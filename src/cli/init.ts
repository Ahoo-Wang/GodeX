...
export function buildConfigYaml(opts: {
	...
	const lines = [
		...
		"models:",
		"  aliases:",
		`    gpt-5.5: ${opts.provider}/glm-5.1`,
		`    gpt-5: ${opts.provider}/glm-5.1`,
		`    gpt-5-mini: ${opts.provider}/glm-5-turbo`,
		`    gpt-4o: ${opts.provider}/glm-4.7`,
		`    gpt-4o-mini: ${opts.provider}/glm-4.7-flash`,
		`    "*": ${opts.provider}/glm-5.1`,
		"",
		"providers:",
		`  ${opts.provider}:`,
		`    api_key: ${opts.apiKey}`,
